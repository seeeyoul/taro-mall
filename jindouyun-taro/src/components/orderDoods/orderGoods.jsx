        ...
        <View className='orderGoods-container'>
            ...
            <View className='name'>
                ...
                <View style={{display: 'flex', marginTop: '30px'}}>
                    ...
                    {props.parent !== 'cart' && <Text>x{data.number}</Text>}
            ...
            {
                props.parent == 'to-be-paid' && <Number className='number' parent={props.parent} data={data} />
            }
            {
                props.parent == 'cart' && <Number className='number' parent={props.parent} data={data} />
            }
            {/* {
