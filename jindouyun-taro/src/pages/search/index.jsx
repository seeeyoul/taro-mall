                ...
                searchInput.length === 0 ?
                    <View>
                        <View className='flex between padding_xs'>
                            <View className='search_tit fontS_36 fontC_70'>热门搜索</View>
                            <Image onClick={deleteHistory} className='search_delete' src={delete_png} />
                        </View>
                        <View className='flex flex_wrap padding_row_xs'>
                            <View className='search_history fontS_20 border_10 fontC_white padding_row_xxs margin_xxs'>小吃</View>
                            <View className='search_history fontS_20 border_10 fontC_white padding_row_xxs margin_xxs'>辣条</View>
                            <View className='search_history fontS_20 border_10 fontC_white padding_row_xxs margin_xxs'>方便面</View>
                            <View className='search_history fontS_20 border_10 fontC_white padding_row_xxs margin_xxs'>薯片</View>
                            <View className='search_history fontS_20 border_10 fontC_white padding_row_xxs margin_xxs'>烧烤</View>
                            <View className='search_history fontS_20 border_10 fontC_white padding_row_xxs margin_xxs'>可乐</View>
                            <View className='search_history fontS_20 border_10 fontC_white padding_row_xxs margin_xxs'>烤肠</View>
                            <View className='search_history fontS_20 border_10 fontC_white padding_row_xxs margin_xxs'>冰淇淋</View>
                            {/*{*/}
                            {/*    historyList.map((e) => {*/}
                            {/*        return (*/}
